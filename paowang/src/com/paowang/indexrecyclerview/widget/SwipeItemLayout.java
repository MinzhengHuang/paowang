...
package com.paowang.indexrecyclerview.widget;
...
public class SwipeItemLayout extends RelativeLayout {
    ...
    private Object performAdapterViewItemLongClick() {
        ViewParent t = getParent();
        if (t instanceof AdapterView) {
            AdapterView view = (AdapterView) t;
            int p = view.getPositionForView(SwipeItemLayout.this);
            ...
            try {
                ...
                handled =m.invoke(view, SwipeItemLayout.this, p, vId);
                ...
                if (Boolean.parseBoolean(handled.toString())) {
    ...
    private void slideTo(int isOpen) {
        if (isOpen == 1) {
            ...
            ViewCompat.getAlpha(mBottomView);
