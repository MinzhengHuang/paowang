package com.paowang.indexrecyclerview;
...
import com.paowang.indexrecyclerview.adapter.CommonString;
import com.paowang.indexrecyclerview.adapter.ContactAdapter;
import com.paowang.indexrecyclerview.adapter.expandRecyclerviewadapter.StickyRecyclerHeadersDecoration;
import com.paowang.indexrecyclerview.model.ContactModel;
import com.paowang.indexrecyclerview.pinyin.CharacterParser;
import com.paowang.indexrecyclerview.pinyin.PinyinComparator;
import com.paowang.indexrecyclerview.widget.DividerDecoration;
import com.paowang.indexrecyclerview.widget.SideBar;
import com.paowang.indexrecyclerview.widget.TouchableRecyclerView;
 ...
 * RecyclerView实现联系人列表
 */
public class IndexRecyclerViewActivity extends Activity {
    ...
    ContactModel mModel;
    private List<ContactModel.MembersEntity> mMembers = new ArrayList<ContactModel.MembersEntity>();
    private CharacterParser characterParser;
    private PinyinComparator pinyinComparator;
    private ContactAdapter mAdapter;
    private List<ContactModel.MembersEntity> mAllLists = new ArrayList<ContactModel.MembersEntity>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indexrecyclerview);
        getPermission();
        initView();
