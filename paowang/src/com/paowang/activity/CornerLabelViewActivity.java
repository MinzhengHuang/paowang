...
import com.paowang.view.CornerLabelView;

import java.util.Random;

public class CornerLabelViewActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cornerlabelview);
