...
public class YummyTextSwitcher extends View {
    ...
    public YummyTextSwitcher(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = arr.getDimensionPixelSize(R.styleable.YummyTextSwitcher_textSize1, 80);
        mTextColor = arr.getColor(R.styleable.YummyTextSwitcher_textColor1, Color.BLACK);
