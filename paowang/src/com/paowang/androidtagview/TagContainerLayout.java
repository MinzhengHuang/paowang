...
public class TagContainerLayout extends ViewGroup {
    ...
    private int[] onGetNewPosition(View view){
        ...
        int top = view.getTop();
        int bestMatchLeft = mViewPos[Integer.parseInt(String.valueOf(view.getTag())) * 2];
        int bestMatchTop = mViewPos[Integer.parseInt(String.valueOf(view.getTag())) * 2 + 1];
    ...
    private class DragHelperCallBack extends ViewDragHelper.Callback{
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            onChangeView(releasedChild, posRefer,Integer.parseInt(String.valueOf(releasedChild.getTag())) * 2);
