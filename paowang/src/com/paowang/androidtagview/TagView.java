        ...
        public void run() {
            if (!isMoved && !isUp){
                ...
                if (state == ViewDragHelper.STATE_IDLE){
                    ...
                    mOnTagClickListener.onTagLongClick(Integer.parseInt(String.valueOf(getTag())), getText());
                }
            }
        }
    };
            ...
            switch (action){
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!isExecLongClick && !isMoved) {
                        mOnTagClickListener.onTagClick(Integer.parseInt(String.valueOf(getTag())), getText());
                    }
                    break;
            }
            return true;
